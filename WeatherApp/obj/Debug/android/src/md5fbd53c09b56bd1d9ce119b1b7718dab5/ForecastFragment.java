...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_onInflate:(Landroid/content/Context;Landroid/util/AttributeSet;Landroid/os/Bundle;)V:GetOnInflate_Landroid_content_Context_Landroid_util_AttributeSet_Landroid_os_Bundle_Handler\n" +
			...
			"";
		mono.android.Runtime.register ("WeatherApp.Fragments.ForecastFragment, WeatherApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ForecastFragment.class, __md_methods);
	}
	...
	public ForecastFragment () throws java.lang.Throwable
	{
		...
		if (getClass () == ForecastFragment.class)
			mono.android.TypeManager.Activate ("WeatherApp.Fragments.ForecastFragment, WeatherApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
	...
	{
		n_onInflate (p0, p1, p2);
	}

	private native void n_onInflate (android.content.Context p0, android.util.AttributeSet p1, android.os.Bundle p2);
